...
export Customized_Information="Trombonist Compiled in $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
...
git clone https://github.com/morytyann/OpenWrt-mihomo.git package/custom/OpenWrt-mihomo
# 更换固件内核
